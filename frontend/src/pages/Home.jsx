      ...
      <div className="max-w-6xl mx-auto space-y-24 px-4 sm:px-6">
        ...
        <footer className="border-t border-white/5 pt-12 pb-8">
          ...
          <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
            <p>Â© 2026 Finlay Technologies Inc. All rights reserved.</p>
            <div className="flex gap-4">
              {/* Social placeholders */}
              <div className="w-8 h-8 rounded-full bg-white/5 hover:bg-white/10 transition-colors cursor-pointer flex items-center justify-center">ð•</div>
